...
class Temp:
    def __init__(self, Year, median, upper, lower):
        self.t = Temperature(Year, median, upper, lower)


class TemperatureReader(Temp):
...
/Users/jakkus/PycharmProjects/CIS41B/venv/bin/python /Users/jakkus/PycharmProjects/CIS41B/frontEnd.py
TEMPERATURE and CO2 EMISSION DATA for the overlapping Years
...
# def get_overlapping_years(temp_obj, co2_obj):
#     return set(co2_obj.co2_dict.keys() & temp_obj.temp_dict.keys() )
#
#
# def print_temp_co2_emi_for_overlapping_years(tmp_obj, co2_obj, overlapping_years):
#     print("TEMPERATURE and CO2 EMISSION DATA for the overlapping Years")
#     print("")
#     for year in overlapping_years:
#         print(f"In the year: {year} Temperature is {tmp_obj.get_temp(year):^10} and CO2 Emission is {co2_obj.get_co2_emission(year):^10}")



# Waste Code from initial testings

# t = TemperatureReader()
# t.temp_reader(TEMPERATURE_DATA_FILE)
# # t.print_temp(2018)
# c = CO2EmissionReader()
# c.co2_emission_reader(CO2_DATA_FILE)
# # c.print_co2_emission(2018)
# overlap_years = get_overlapping_years(t, c)
# print_temp_co2_emi_for_overlapping_years(t, c, overlap_years)
    ...
    # ct.get_overlapping_year()
        ...
        # self.t = TemperatureReader().__init__()
        # self.c = CO2EmissionReader().__init__()
#
#     def Co2AndTempReader(self):
#         self.t.temp_reader(TEMPERATURE_DATA_FILE)
#         self.c.CO2EmissionReader.co2_emission_reader(CO2_DATA_FILE)
#
#     def get_overlapping_year(self):
#         temp_years_set = set(self.temp_dict)
#         co2_years_set = set(self.co2_dict)
#
#         for year in temp_years_set.intersection(co2_years_set):
#             print(year, end=",")


# print(type(temp_obj))
# print(type(co2_obj))
# temp_years_set = set(temp_obj.temp_dict)
# co2_em_years_set = set(co2_obj.co2_dict)

# print(temp_years_set)
# print(co2_em_years_set)

"""

I have following 2 classes. How can create 3rd class with these 2 classes and call the init methods of both classes. Below 3rd class init method is not working
# class TempVsCO2Emission(TemperatureReader, CO2EmissionReader):
#
#     def __init__(self):
#         self.t = TemperatureReader().__init__()
