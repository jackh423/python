...
#     pounds = penny // 240
#     reminder_pennies = penny % 240
#     shillings = reminder_pennies // 12
#     pennies = penny % 12
#
...
class BritCoins(object):
    ...
    def __add__(self, other):
        ...
        # pounds, shillings, pennies = BritCoins.return_proper_coins(total)
        # return BritCoins(pound=pounds, shilling=shillings, penny=pennies)
